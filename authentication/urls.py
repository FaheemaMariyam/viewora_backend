...
from .views import (RegisterView, LoginView, ProfileView, LogoutView,ChangePasswordView,ResetPasswordConfirmView,
                    ResetPasswordRequestView,AdminOTPVerifyView,SendPhoneOTPView,VerifyPhoneOTPView)
